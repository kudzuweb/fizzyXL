...
Rails.application.configure do
  ...
  config.action_controller.default_url_options = { host: config.hosts.first, port: 3009 }
  config.action_mailer.default_url_options     = { host: config.hosts.first, port: 3009 }
end
